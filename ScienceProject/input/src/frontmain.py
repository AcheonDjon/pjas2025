...
import outliers
import os
folder_pathleft = r"input\src\frontveiw"
#starttimes1 =[27,83,23,53,62,41,27.4,90,44,32,43.8,24,21,34, 47, 27, 40.2,18, 56.5, 68, 52,39.5,30.6,30.2]
starttimes =[27, 18, 52,39.5,30.6,31,23,53,42,28,90]
filenames = sorted(os.listdir(folder_pathleft))
print(filenames)
for idx, filename in enumerate(os.listdir(folder_pathleft)):
    ...
    if os.path.isfile(file_path):
        ...
        try:
            ...
            df.to_csv(f"input\src\cleaneddata\{filename}.csv", index=False)
